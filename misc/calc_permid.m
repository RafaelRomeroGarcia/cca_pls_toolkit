...
%   remove runtype as input

% Load cfg
cfg = loadmat(res, fullfile(res.dir.frwork, 'cfg.mat'), 'cfg');

% Initialize file
file = fullfile(res.dir.frwork, 'perm', sprintf('permmat_%d.mat', res.stat.nperm));
...
% Save permutations
if ~isdir(fullfile(res.dir.frwork, 'perm'))
    mkdir(fullfile(res.dir.frwork, 'perm'))
end
