...
%   add clean up for folder in bootstrapping analysis
...
%     end
    ...
    % Clean up boot folder
    if cfg.stat.nboot > 0
        renamemat(cfg, fullfile(res.dir.boot, 'allboot.mat'));
        renamemat(cfg, fullfile(res.dir.frwork, 'boot', sprintf('bootmat_%d.mat', cfg.stat.nboot)));
        delete(fullfile(res.dir.boot, 'boot_*.mat'));
    end
